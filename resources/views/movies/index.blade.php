    ...
    <div class="container mx-auto mt-10">
        <div class="max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-gray-100 overflow-hidden shadow-sm rounded-lg">
                <h1>Movies</h1>
                <div class="w-64  shadow rounded border border-black">
                        ...
                        <div class="flex justify-start">
                            ...
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 border border-red-500">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="p-4 bg-gradient-to-r from-purple-900 to-black text-white hover:from-pink-900 hover:to-black">
