            ...
            <section class="grid grid-cols-4 mb-10 gap-x-4">
                <article class="col-span-4 md:col-span-1">
                    <img class="md:-mt-40  w-0 md:w-80  border border-gray-500 rounded-xl mb-5 "src="{{ asset('storage/perfil/' . $serie->images->where('destination', 'perfil')->pluck('url')->first()) }}"
                        ...
                        <section class="flex justify-center gap-x-3   text-white items-center border border-gray-500 p-3">
                            ...
                            @auth    
                                ...
                                <div class="border border-gray-600 bg-gradient-to-r from-pink-900 via-black to-black hover:from-pink-900 hover:via-pink-800 hover:to-black rounded-full p-2">
                                    <livewire:seen-component :modelo='$serie' />
                                </div>
                            @endauth
                        </section>    
                </article>
                <article class="col-span-4 md:col-span-3 pt-5 text-white px-3">
                    ...
                    <section class="flex gap-x-5">
                        <span class="text-gray-400 capitalize">
                            <small class="text-gray-500">@ </small>{{ $serie->nameEn }}
                        </span>
                    </section>
                    {{-- premiere, genre  --}}
                    <span class="flex gap-x-2 mt-2 mb-2">
                        ...
                        <span class="text-teal-200 tracking-widest">{{ $serie->premiere->toFormattedDateString() }} (País)</span>
                        •
                        <span class="text-yellow-500">
                            {{ $serie->seasons }} @choice('Temporada|Temporadas', $serie->seasons ) 
                        </span>
                        •
